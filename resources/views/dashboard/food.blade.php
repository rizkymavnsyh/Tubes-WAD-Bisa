...
@section('header', 'Manajemen Makanan')
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Tabel Data Makanan</h6>
            <a href="{{ route('produk.food.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a>
        </div>
    </div>
    <div class="card-body">
        <!-- Filter dan Ekspor -->
        <div class="row mb-3">
            ...
            <div class="col-md-4 text-right">
                <a href="{{ route('produk.food.export.pdf') }}" class="btn btn-danger btn-sm"><i class="fas fa-file-pdf"></i> PDF</a>
